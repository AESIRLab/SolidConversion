...
import com.example.solidconversion.getUnsafeOkHttpClient
import com.example.solidconversion.okHttpRequest
import com.example.solidconversion.R
import com.example.solidconversion.StartButton
...
fun StartAuthScreen(
    ...
    Column(
        ...
        StartButton(text = "Start") {
            ...
            val redirectUris = listOf("app://www.solid-oidc.com/solidconversion")
